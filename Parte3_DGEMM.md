...
Os testes foram realizados em Windows, com Intel Core i5-10210U, 4 nucleos, 8 threads, aproximadamente 8 GB de RAM e GCC 8.1.0. AVX2, FMA e OpenMP estavam disponiveis. A ausencia de `make`, MKL, PyTorch e CUDA impediu comparacoes com essas ferramentas, mas nao impediu a execucao das versoes C avaliadas.
